...
export const TechLanding = () => {
    ...
    const startData = async ()=> {
        ...
        const tempCompData = await techLandingStartData();
        if (!tempCompData){
    ...
    return(
        <>
            ...
            <NavBar companyName={compData && compData.companyName}/>
                                ...
                                <div className='techLand--equips-container'>
                                    ...
                                    <div key={eqIndex} className='techLand--equip-container'>
                                        ...
                                        <div className={expandedEquip === eqIndex ? 'techLand--equip-body visible' : 'techLand--equip-body'}>
                                            ...
                                            <div className='techLand--label-button-container' onClick={()=>{gotoQrClick(compData.id, eq.id)}}>
